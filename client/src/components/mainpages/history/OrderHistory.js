...
function OrderHistory() {
    ...
    return (
        <div className="history-page">
            ...
            <h3 style={{ fontFamily: "Wellfleet"}}>Amint egyszer megtudod, mi a szeretet, készen állsz arra, hogy adj; minél többet adsz, annál több lesz neked. Minél bőkezűbben halmozol el másokat, annál több szeretet tör fel a lényedben. /Osho/</h3>
            </div>
